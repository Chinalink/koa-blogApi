 ...
 * @LastEditTime: 2021-04-07 20:55:56
 */
const fs = require('fs')
...
const uploadService = {
  ...
  reName(fileName) {
    ...
    const prefix = dayjs(new Date()).format('YYYYMMDD')
  ...
  setFilePath(type) {
    ...
    const yearPath = dayjs(new Date()).format('YYYY')
    const monthPath = dayjs(new Date()).format('MM')
